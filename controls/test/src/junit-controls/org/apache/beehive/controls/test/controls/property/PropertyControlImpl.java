...
public class PropertyControlImpl implements PropertyControl {
    ...
    public String getAttribute1ByContext() {
        ...
        PropertyOne propertyOne = (PropertyControl.PropertyOne) context.getControlPropertySet(PropertyControl.PropertyOne.class);
    ...
    public String getAttribute3ByContext() {
        /**BUG: could not refer to Greeting directly*/
        PropertyTwo propertyTwo = (PropertyControl.PropertyTwo) context.getControlPropertySet(PropertyControl.PropertyTwo.class);
