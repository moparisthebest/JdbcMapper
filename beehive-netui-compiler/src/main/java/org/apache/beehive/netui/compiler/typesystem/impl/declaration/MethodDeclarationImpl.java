...
{
    public MethodDeclarationImpl( com.sun.mirror.declaration.MethodDeclaration delegate )
    {
        super( delegate );
    }
    ...
    {
        return WrapperFactory.get().getTypeInstance( ( ( com.sun.mirror.declaration.MethodDeclaration ) getDelegate() ).getReturnType() );
    }
}
