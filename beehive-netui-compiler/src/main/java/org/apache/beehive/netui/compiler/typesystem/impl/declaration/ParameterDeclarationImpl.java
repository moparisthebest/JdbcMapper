...
{
    public ParameterDeclarationImpl( com.sun.mirror.declaration.ParameterDeclaration delegate )
    {
        super( delegate );
    }
    ...
    {
        return WrapperFactory.get().getTypeInstance( ( ( com.sun.mirror.declaration.ParameterDeclaration ) getDelegate() ).getType() );
    }
