...
/**
 * This page flow contains an integer variable and an action to increment it, as well as some
 * common actions and lifecycle methods.  It's extended by the other page flows in this sample, and
