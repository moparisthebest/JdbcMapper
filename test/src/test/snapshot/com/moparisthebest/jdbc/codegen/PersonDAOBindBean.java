...
public class PersonDAOBindBean implements PersonDAO {
	...
	public PersonDAOBindBean() throws SQLException {
		this(_conFactory);
	}

	private PersonDAOBindBean(final Connection conn, final boolean closeConn) {
		this.conn = conn;
	...
	public PersonDAOBindBean(Connection conn) {
		this(conn, false);
	}
...
ret.put("last_name", rs.getString(2));
	...
	public PersonDAOBindBean(final Factory<Connection> connectionFactory) throws SQLException {
		this(connectionFactory.create(), true);
	}

	public PersonDAOBindBean(final String jndiName) throws SQLException {
