...
public class PersonDAOOracleBean implements PersonDAO {
	...
	public PersonDAOOracleBean() throws SQLException {
		this(_conFactory);
	}

	private PersonDAOOracleBean(final Connection conn, final boolean closeConn) {
		this.conn = conn;
	...
	public PersonDAOOracleBean(Connection conn) {
		this(conn, false);
	}
...
_rs.getString(3));
	...
	@Override
	public java.util.stream.Stream<com.moparisthebest.jdbc.dto.FieldPerson> getPeopleStream(final long personNo1, final long personNo2, final long personNo3) throws java.sql.SQLException {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT person_no, birth_date, last_name, first_name from person WHERE person_no IN (?,?,?) ORDER BY person_no");
...
_rs.getString(3));
				...
				: null, null).onClose(() -> tryClose(finalPs));
		} catch(Throwable e) {
			tryClose(rs);
			tryClose(ps);
			if(e instanceof SQLException)
	...
	@Override
	public java.util.stream.Stream<com.moparisthebest.jdbc.dto.FieldPerson> getPeopleStreamCachedPreparedStatement(final long personNo1, final long personNo2, final long personNo3) throws java.sql.SQLException {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = this.prepareStatement(2, "SELECT person_no, birth_date, last_name, first_name from person WHERE person_no IN (?,?,?) ORDER BY person_no");
			ps.setObject(1, personNo1);
			ps.setObject(2, personNo2);
			ps.setObject(3, personNo3);
			rs = ps.executeQuery();
...
com.moparisthebest.jdbc.util.ReflectionUtil.setValue(_fields[1], ret, rs.getString(2));
	...
	@Override
	public java.util.stream.Stream<com.moparisthebest.jdbc.dto.FieldPerson> getPeopleInListStream(final java.util.stream.Stream<java.lang.Long> personNos, final java.util.stream.Stream<java.lang.String> names) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		final Array[] _bindArrays = new Array[2];
		try {
			_bindArrays[0] = conn.createArrayOf("NUMERIC", personNos.toArray(java.lang.Long[]::new));
			_bindArrays[1] = conn.createArrayOf("TEXT", names.toArray(java.lang.String[]::new));
			ps = conn.prepareStatement("SELECT first_name, last_name FROM person WHERE (person_no = ANY(?)) OR (first_name = ANY(?)) OR (last_name = ANY(?))");
			ps.setArray(1, _bindArrays[0]);
			...
			return com.moparisthebest.jdbc.util.ResultSetIterable.getStream(rs,
					rs.next() ? (_rs, _cal) -> {
final com.moparisthebest.jdbc.dto.FieldPerson ret = new com.moparisthebest.jdbc.dto.FieldPerson();
com.moparisthebest.jdbc.util.ReflectionUtil.setValue(_fields[0], ret, _rs.getString(1));
com.moparisthebest.jdbc.util.ReflectionUtil.setValue(_fields[1], ret, _rs.getString(2));
						return ret;
					}
				: null, null).onClose(() -> tryClose(finalPs));
		} catch(Throwable e) {
	...
	@Override
	public java.time.Instant getBirthDateInstant(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.Instant ret = com.moparisthebest.jdbc.util.ResultSetUtil.getInstant(rs, 1);
	...
	@Override
	public java.time.LocalDateTime getBirthDateLocalDateTime(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.LocalDateTime ret = com.moparisthebest.jdbc.util.ResultSetUtil.getLocalDateTime(rs, 1);
	...
	@Override
	public java.time.LocalDate getBirthDateLocalDate(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.LocalDate ret = com.moparisthebest.jdbc.util.ResultSetUtil.getLocalDate(rs, 1);
	...
	@Override
	public java.time.LocalTime getBirthDateLocalTime(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.LocalTime ret = com.moparisthebest.jdbc.util.ResultSetUtil.getLocalTime(rs, 1);
	...
	@Override
	public java.time.ZonedDateTime getBirthDateZonedDateTime(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.ZonedDateTime ret = com.moparisthebest.jdbc.util.ResultSetUtil.getZonedDateTime(rs, 1);
	...
	@Override
	public java.time.OffsetDateTime getBirthDateOffsetDateTime(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.OffsetDateTime ret = com.moparisthebest.jdbc.util.ResultSetUtil.getOffsetDateTime(rs, 1);
	...
	@Override
	public java.time.OffsetTime getBirthDateZonedOffsetTime(final long personNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT birth_date FROM person WHERE person_no = ?");
...
final java.time.OffsetTime ret = com.moparisthebest.jdbc.util.ResultSetUtil.getOffsetTime(rs, 1);
	...
	@Override
	public java.time.Year getYearInt(final long valNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT num_val FROM val WHERE val_no = ?");
...
final java.time.Year ret = com.moparisthebest.jdbc.util.ResultSetUtil.getYear(rs, 1);
	...
	@Override
	public java.time.Year getYearString(final long valNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT str_val FROM val WHERE val_no = ?");
			ps.setObject(1, valNo);
			rs = ps.executeQuery();
			if(rs.next()) {
final java.time.Year ret = com.moparisthebest.jdbc.util.ResultSetUtil.getYear(rs, 1);
	...
	@Override
	public java.time.ZoneId getZoneId(final long valNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT str_val FROM val WHERE val_no = ?");
...
final java.time.ZoneId ret = com.moparisthebest.jdbc.util.ResultSetUtil.getZoneId(rs, 1);
	...
	@Override
	public java.time.ZoneOffset getZoneOffsetInt(final long valNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT num_val FROM val WHERE val_no = ?");
...
final java.time.ZoneOffset ret = com.moparisthebest.jdbc.util.ResultSetUtil.getZoneOffset(rs, 1);
	...
	@Override
	public java.time.ZoneOffset getZoneOffsetStr(final long valNo) {
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT str_val FROM val WHERE val_no = ?");
...
ret.put("last_name", rs.getString(2));
	...
	private final PreparedStatement[] psCache = new PreparedStatement[3];
	...
	public PersonDAOOracleBean(final Factory<Connection> connectionFactory) throws SQLException {
		this(connectionFactory.create(), true);
	}

	public PersonDAOOracleBean(final String jndiName) throws SQLException {
