...
public class PersonDAOAnyBean implements PersonDAO {
	...
	public PersonDAOAnyBean() throws SQLException {
		this(_conFactory);
	}

	private PersonDAOAnyBean(final Connection conn, final boolean closeConn) {
		this.conn = conn;
	...
	public PersonDAOAnyBean(Connection conn) {
		this(conn, false);
	}
...
ret.put("last_name", rs.getString(2));
	...
	public PersonDAOAnyBean(final Factory<Connection> connectionFactory) throws SQLException {
		this(connectionFactory.create(), true);
	}

	public PersonDAOAnyBean(final String jndiName) throws SQLException {
