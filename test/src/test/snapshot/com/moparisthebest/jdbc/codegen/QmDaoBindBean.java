...
final java.time.ZoneOffset ret = com.moparisthebest.jdbc.util.ResultSetUtil.getZoneOffset(rs, 1);
	...
	public java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> getFieldPeopleStream(final java.util.stream.Stream<java.lang.Long> personNos) throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			final java.lang.Long[] _personNosStreamAsBindArray = personNos.toArray(java.lang.Long[]::new);
			ps = conn.prepareStatement("SELECT person_no, first_name, last_name, birth_date from person WHERE " + com.moparisthebest.jdbc.util.InListUtil.toInList("person_no", _personNosStreamAsBindArray) + " ORDER BY person_no");
			int psParamCount = 0;
			for(final java.lang.Long _bindInListParam : _personNosStreamAsBindArray)
...
final java.lang.Long ret = com.moparisthebest.jdbc.util.ResultSetUtil.getObjectLong(rs, 1);
	...
	private final PreparedStatement[] psCache = new PreparedStatement[58];
