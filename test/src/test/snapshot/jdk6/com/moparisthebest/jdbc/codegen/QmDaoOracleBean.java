...
public class QmDaoOracleBean implements QmDao {

	private final Connection conn;
	private final boolean closeConn;


	private QmDaoOracleBean(final Connection conn, final boolean closeConn) {
		this.conn = conn;
	...
	public QmDaoOracleBean(Connection conn) {
		this(conn, false);
	}
...
_rs.getString(3));
	...
	public com.moparisthebest.jdbc.dto.EnumPerson getEnumPerson(final long personNo) throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = this.prepareStatement(39, "SELECT first_name, last_name FROM person WHERE person_no = ?");
			ps.setObject(1, personNo);
			rs = ps.executeQuery();
			if(rs.next()) {
...
ret.setLastName(rs.getString(2));
	...
	public com.moparisthebest.jdbc.dto.EnumPerson getEnumPersonConstructor(final long personNo) throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = this.prepareStatement(40, "SELECT first_name FROM person WHERE person_no = ?");
			ps.setObject(1, personNo);
			rs = ps.executeQuery();
			if(rs.next()) {
final com.moparisthebest.jdbc.dto.EnumPerson ret = new com.moparisthebest.jdbc.dto.EnumPerson(
...
final com.moparisthebest.jdbc.dto.FirstName ret = com.moparisthebest.jdbc.util.ResultSetUtil.getEnum(rs, 1, com.moparisthebest.jdbc.dto.FirstName.class);
	...
	public com.moparisthebest.jdbc.dto.EnumPerson getEnumPersonNull() throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = this.prepareStatement(42, "SELECT str_val as first_name, str_val as last_name FROM val WHERE val_no = 4");
			rs = ps.executeQuery();
			if(rs.next()) {
final com.moparisthebest.jdbc.dto.EnumPerson ret = new com.moparisthebest.jdbc.dto.EnumPerson();
ret.setFirstName(com.moparisthebest.jdbc.util.ResultSetUtil.getEnum(rs, 1, com.moparisthebest.jdbc.dto.FirstName.class));
ret.setLastName(rs.getString(2));
	...
	public com.moparisthebest.jdbc.dto.FirstName getFirstNameNull() throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = this.prepareStatement(43, "SELECT str_val FROM val WHERE val_no = 4");
			rs = ps.executeQuery();
			if(rs.next()) {
final com.moparisthebest.jdbc.dto.FirstName ret = com.moparisthebest.jdbc.util.ResultSetUtil.getEnum(rs, 1, com.moparisthebest.jdbc.dto.FirstName.class);
				return ret;
	...
	public com.moparisthebest.jdbc.dto.CaseSensitivePerson getCaseSensitivePerson(final long personNo) throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = this.prepareStatement(44, "SELECT first_name AS M_PERSON_FIRST_NAME FROM person WHERE person_no = ?");
			ps.setObject(1, personNo);
			rs = ps.executeQuery();
			if(rs.next()) {
...
ret.setmPersonFirstName(rs.getString(1));
	...
	public java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> getFieldPeople(final java.util.List<java.lang.Long> personNos) throws java.sql.SQLException {
		...
		try {
			...
			ps = this.prepareStatement(45, "SELECT person_no, first_name, last_name, birth_date from person WHERE (person_no IN(select column_value from table(?))) ORDER BY person_no");
...
rs.getString(3));
	...
	public java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> getFieldPeopleByName(final java.util.List<java.lang.Long> personNos, final java.util.List<java.lang.String> names) throws java.sql.SQLException {
		...
		try {
			_bindArrays[0] = conn.unwrap(oracle.jdbc.OracleConnection.class).createOracleArray("ARRAY_NUM_TYPE", personNos.toArray(new java.lang.Long[personNos.size()]));
			_bindArrays[1] = conn.unwrap(oracle.jdbc.OracleConnection.class).createOracleArray("ARRAY_STR_TYPE", names.toArray(new java.lang.String[names.size()]));
			ps = this.prepareStatement(46, "SELECT person_no, first_name, last_name, birth_date from person WHERE (person_no IN(select column_value from table(?))) AND ((first_name IN(select column_value from table(?))) OR (last_name IN(select column_value from table(?)))) ORDER BY person_no");
			ps.setArray(1, _bindArrays[0]);
...
rs.getString(3));
	...
	public java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> getFieldPeopleNotIn(final java.util.List<java.lang.Long> personNos) throws java.sql.SQLException {
		...
		try {
			_bindArrays[0] = conn.unwrap(oracle.jdbc.OracleConnection.class).createOracleArray("ARRAY_NUM_TYPE", personNos.toArray(new java.lang.Long[personNos.size()]));
			ps = this.prepareStatement(47, "SELECT person_no, first_name, last_name, birth_date from person WHERE (person_no NOT IN(select column_value from table(?))) ORDER BY person_no");
			ps.setArray(1, _bindArrays[0]);
			rs = ps.executeQuery();
			final java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> _colret = new java.util.ArrayList<com.moparisthebest.jdbc.dto.FieldPerson>();
			while(rs.next()) {
...
rs.getString(3));
	...
	public long insertGetGeneratedKeyOracle(final long value) throws java.sql.SQLException {
		PreparedStatement ps = null;
		try {
			ps = conn.prepareStatement("INSERT INTO a_thaoeu_table (a_thaoeu_table_no, a_thaoeu_table_val) VALUES (a_thaoeu_table_seq.nextval, ?)", new int[]{1});
	...
	public long insertGetGeneratedKey(final long value) throws java.sql.SQLException {
		PreparedStatement ps = null;
		try {
			ps = conn.prepareStatement("INSERT INTO a_thaoeu_table (a_thaoeu_table_val) VALUES (?)", new int[]{1});
			ps.setObject(1, value);
			ps.executeUpdate();
			ResultSet rs = null;
			try {
...
final java.lang.Long ret = com.moparisthebest.jdbc.util.ResultSetUtil.getObjectLong(rs, 1);
	...
	public QmDaoOracleBean(final Factory<Connection> connectionFactory) throws SQLException {
		this(connectionFactory.create(), true);
	}

	public QmDaoOracleBean(final String jndiName) throws SQLException {
		this(com.moparisthebest.jdbc.codegen.JdbcMapperFactory.connectionFactory(jndiName));
	}

	@Override
	public SqlBuilder sqlBuilder() {
		return SqlBuilder.of(conn, com.moparisthebest.jdbc.OracleArrayInList.instance());
	}
}
