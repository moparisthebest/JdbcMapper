...
public class QmDaoBindBean implements QmDao {

	private final Connection conn;
	private final boolean closeConn;


	private QmDaoBindBean(final Connection conn, final boolean closeConn) {
		this.conn = conn;
	...
	public QmDaoBindBean(Connection conn) {
		this(conn, false);
	}
...
rs.getString(3));
	...
	public java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> getFieldPeopleByName(final java.util.List<java.lang.Long> personNos, final java.util.List<java.lang.String> names) throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT person_no, first_name, last_name, birth_date from person WHERE " + com.moparisthebest.jdbc.util.InListUtil.toInList("person_no", personNos) + " AND (" + com.moparisthebest.jdbc.util.InListUtil.toInList("first_name", names) + " OR " + com.moparisthebest.jdbc.util.InListUtil.toInList("last_name", names) + ") ORDER BY person_no");
			int psParamCount = 0;
			for(final java.lang.Long _bindInListParam : personNos)
				ps.setObject(++psParamCount, _bindInListParam);
			for(final java.lang.String _bindInListParam : names)
				ps.setObject(++psParamCount, _bindInListParam);
			for(final java.lang.String _bindInListParam : names)
				ps.setObject(++psParamCount, _bindInListParam);
			rs = ps.executeQuery();
...
rs.getString(3));
	...
	public java.util.List<com.moparisthebest.jdbc.dto.FieldPerson> getFieldPeopleNotIn(final java.util.List<java.lang.Long> personNos) throws java.sql.SQLException {
		...
		ResultSet rs = null;
		try {
			ps = conn.prepareStatement("SELECT person_no, first_name, last_name, birth_date from person WHERE " + com.moparisthebest.jdbc.util.InListUtil.toNotInList("person_no", personNos) + " ORDER BY person_no");
			int psParamCount = 0;
			for(final java.lang.Long _bindInListParam : personNos)
				ps.setObject(++psParamCount, _bindInListParam);
			rs = ps.executeQuery();
...
final java.lang.Long ret = com.moparisthebest.jdbc.util.ResultSetUtil.getObjectLong(rs, 1);
	...
	private final PreparedStatement[] psCache = new PreparedStatement[45];
	...
	public QmDaoBindBean(final Factory<Connection> connectionFactory) throws SQLException {
		this(connectionFactory.create(), true);
	}

	public QmDaoBindBean(final String jndiName) throws SQLException {
		this(com.moparisthebest.jdbc.codegen.JdbcMapperFactory.connectionFactory(jndiName));
	}

	@Override
	public SqlBuilder sqlBuilder() {
		return SqlBuilder.of(conn, com.moparisthebest.jdbc.BindInList.instance());
	}
}
