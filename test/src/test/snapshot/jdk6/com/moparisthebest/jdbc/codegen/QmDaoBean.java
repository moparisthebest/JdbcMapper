...
public class QmDaoBean implements QmDao {

	private final Connection conn;
	private final boolean closeConn;


	private QmDaoBean(final Connection conn, final boolean closeConn) {
		this.conn = conn;
	...
	public QmDaoBean(Connection conn) {
		this(conn, false);
	}
...
final java.lang.Long ret = com.moparisthebest.jdbc.util.ResultSetUtil.getObjectLong(rs, 1);
	...
	public QmDaoBean(final Factory<Connection> connectionFactory) throws SQLException {
		this(connectionFactory.create(), true);
	}

	public QmDaoBean(final String jndiName) throws SQLException {
