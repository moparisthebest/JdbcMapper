...
class DefaultSQLSupportConfig
    ...
    /**
     * Setter to provide the character used to quote strings built when constructing
     * SQL statements.  The default quote value is a single quote.
     *
     * @param quoteChar the quote character to use; usually a single or double quote
     */
    ...
    public boolean getSupportsLikeEscapeClause() {
        return (_supportsLikeEscapeClause != null ? _supportsLikeEscapeClause.booleanValue() : DEFAULT_SUPPORTS_LIKE_ESCAPE_CLAUSE);
    }
}
