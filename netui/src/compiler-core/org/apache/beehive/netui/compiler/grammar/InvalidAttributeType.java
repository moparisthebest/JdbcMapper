...
/**
 * Type that simply causes an error if present.
 */ 
public class InvalidAttributeType
        extends AnnotationMemberType
{
    private String _errorKey;
    private Object[] _errorArgs;
    
    public InvalidAttributeType( String requiredRuntimeVersion, AnnotationGrammar parentGrammar, String errorKey,
                                 Object[] errorArgs )
    {
    ...
    {
        addError( member, _errorKey, _errorArgs );
        return null;
    }
}
