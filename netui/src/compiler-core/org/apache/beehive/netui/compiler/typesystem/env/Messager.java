...
public interface Messager
{
    ...
    void printError( SourcePosition sourcePosition, String s );

    void printWarning( String s );

    void printWarning( SourcePosition sourcePosition, String s );

    void printNotice( String s );

    void printNotice( SourcePosition sourcePosition, String s );
}
