...
{
    public InterfaceTypeImpl( com.sun.mirror.type.InterfaceType delegate )
    {
        super( delegate );
    }
    ...
    {
        return WrapperFactory.get().getInterfaceDeclaration( ( ( com.sun.mirror.type.InterfaceType ) getDelegate() ).getDeclaration() );
    }
}
