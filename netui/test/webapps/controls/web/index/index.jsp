...
<netui:html>
    ...
    <div class="title">Beehive NetUI Controls Tests</div>
    ...
    <div id="content">
     <netui-data:repeater dataSource="pageFlow.tests">
         ...
         <netui-data:repeaterItem>
             ...
             <td class="nameColumn"><netui:anchor href="/controlsWeb/testRecorder?mode=displayLink">${container.item.name}
                 <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor></td>
             <td class="diffColumn">
                 <c:if test="${container.item.diff == true}">
                 <netui:anchor href="/controlsWeb/testRecorder?mode=diff">Diff
                     <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor>
                 </c:if>
             &nbsp;
              ...
              <td class="detailColumn"><netui:anchor href="/controlsWeb/testRecorder?mode=details">Details
                 <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor></td>
            </tr>
         </netui-data:repeaterItem>
