    ...
    <div id="content">
     <netui-data:repeater dataSource="pageFlow.tests">
         ...
         <netui-data:repeaterItem>
             ...
             <td class="nameColumn"><netui:anchor href="/tomcatWeb/testRecorder?mode=displayLink">${container.item.name}
                 <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor></td>
             <td class="diffColumn">
                 <c:if test="${container.item.diff == true}">
                 <netui:anchor href="/tomcatWeb/testRecorder?mode=diff">Diff
                     <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor>
                 </c:if>
             &nbsp;
              ...
              <td class="detailColumn"><netui:anchor href="/tomcatWeb/testRecorder?mode=details">Details
                 <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor></td>
            </tr>
         </netui-data:repeaterItem>
