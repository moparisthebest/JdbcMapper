<netui-data:dataGrid dataSource="pageScope.stocks" name="portfolio">
    ...
    <netui-data:rows>
        <netui-data:spanCell value="${container.item.symbol}" tagId="symbolSpan"/>
        ...
        <netui-data:imageCell src="no-such-img.gif"/>
        <netui-data:imageAnchorCell src="no-such-img.gif"/>
    </netui-data:rows>
</netui-data:dataGrid>
