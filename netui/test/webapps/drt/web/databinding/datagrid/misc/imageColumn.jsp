...
<netui-template:template templatePage="../site/template.jsp">
    ...
    <netui-data:header>
        ...
        <netui-data:headerCell headerText="Symbol Image"/>
    </netui-data:header>
        <netui-data:rows>
            <netui-data:templateCell>
                <netui:span value="${container.item.symbol}"/>
            </netui-data:templateCell>
            <netui-data:imageCell src="${pageContext.request.contextPath}/databinding/datagrid/images/${container.item.symbol}.gif"/>
        </netui-data:rows>
    </netui-data:dataGrid>
    <br/>
    </p>
