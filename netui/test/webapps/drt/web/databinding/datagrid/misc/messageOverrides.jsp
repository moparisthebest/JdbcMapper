...
<netui-template:template templatePage="../site/template.jsp">
    <netui-template:setAttribute name="title" value="Message Overrides"/>
    <netui-template:section name="body">
    <p>
    <datagrid:portfolioXmlBean/>
    <br/>
    <br/>
    <b>Message Overrides via behavior</b>
    <br/>
    <br/>
    <netui-data:dataGrid dataSource="pageScope.stocks" name="portfolio">
        <netui-data:configurePager defaultPageSize="2"/>
        <netui:behavior facet="resource" name="pager.msg.next" value=">>"/>
        <netui:behavior facet="resource" name="pager.msg.previous" value="<<"/>
        <netui-data:header>
