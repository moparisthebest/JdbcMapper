  ...
  <netui:body>
    ...
    <netui-data:header>
        <netui-data:headerCell headerText="Symbol">
            <netui:behavior facet="renderer" name="extends" value="databinding.datagrid.decorator.HelloWorldDecorator"/>
        </netui-data:headerCell>
        <netui-data:headerCell headerText="Price">
            <netui:behavior facet="renderer" name="extends" value="databinding.datagrid.decorator.HelloWorldDecorator"/>
            <netui:behavior facet="renderer" name="extends" value="databinding.datagrid.decorator.FooDecorator"/>
        </netui-data:headerCell>
