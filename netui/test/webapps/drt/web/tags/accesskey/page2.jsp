...
<netui:html>
    ...
    <body>
        ...
        <b>Color:</b> <netui:span value="${pageInput.form.color}"></netui:span><br/>
        <b>Description:</b> <netui:span value="${pageInput.form.description}"></netui:span><br/>
        <b>Disabled:</b> <netui:span value="${pageInput.form.disabled}"></netui:span><br/>
        <b>Name:</b> <netui:span value="${pageInput.form.name}"></netui:span><br/>
