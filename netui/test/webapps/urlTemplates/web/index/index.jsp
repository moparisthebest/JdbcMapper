    ...
    <div id="content">
     <netui-data:repeater dataSource="pageFlow.tests">
         ...
         <netui-data:repeaterItem>
             ...
             <td class="nameColumn"><netui:anchor href="/urlTemplates/testRecorder?mode=displayLink">${container.item.name}
             ...
             &nbsp;
              ...
              <td class="detailColumn"><netui:anchor href="/urlTemplates/testRecorder?mode=details">Details
                 <netui:parameter name="file" value="${container.item.name}"/>
                 </netui:anchor></td>
            </tr>
         </netui-data:repeaterItem>
