...
/**
 * This JCX defines a reference to a Entity bean
 */
@ControlExtension
@EJBControl.EJBHome(jndiName ="ejb.LocalEntityBeanRemote", ejbLink="ejb.MockEnitityEjbLink")
public interface LocalEntityEjbControl
    extends EntityLocal, EntityLocalHome, EntityEJBControl
{
