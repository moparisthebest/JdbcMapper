...
{
    public SimpleEntityRemote create(String id) throws RemoteException, CreateException;

    public SimpleEntityRemote findByPrimaryKey(String key) throws RemoteException, CreateException;
