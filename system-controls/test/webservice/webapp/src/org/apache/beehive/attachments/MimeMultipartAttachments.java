...
/**
 * Abstract base class for mime multipart tests.
 */
public abstract class MimeMultipartAttachments {

    public abstract MimeMultipart echoPlainText(MimeMultipart plainText);

    public abstract MimeMultipart echoXmlText(MimeMultipart xmlText);

    public abstract MimeMultipart getImages();
