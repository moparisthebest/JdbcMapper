...
/**
 * Tests for Xml Source attachments for rpc/lit services.
 */
public class XmlSourceRpcLitTest
        extends ControlTestCase {

    @Control
    public schematypestest.XmlSourceRpcLitService client;
    ...
    public static Test suite() {
        return new TestSuite(XmlSourceRpcLitTest.class);
    }
