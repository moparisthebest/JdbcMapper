...
/**
 * Tests for MimeMultipart attachments for rpc/enc services.
 */
public class MimeMultipartRpcEncTest
        extends ControlTestCase {

    @Control
    public schematypestest.MimeMultipartRpcEncService client;
...
//
// todo: broken appears to be AXIS bug
...
//        assertEquals(324, img.getWidth(null));
    ...
    public static Test suite() {
        return new TestSuite(MimeMultipartRpcEncTest.class);
    }
