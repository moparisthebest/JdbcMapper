 ...
 */
public class HeaderObjectRpcLitEndpointTest
    extends ControlTestCase {

    @Control
    public pojotypetest.HeaderObjectRpcLitEndpointService client;
    ...
    public static Test suite() {
        return new TestSuite(HeaderObjectRpcLitEndpointTest.class);
    }
